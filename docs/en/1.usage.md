...
Three formats are supported by jsMind: `node-tree format`,`table-format`,`freemind-format`. jsMind can load either format below, also can export data for any format.
