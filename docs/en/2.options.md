 ...
 * x1,y1 are start point, which is the child node coordinate, x2,y2 are end point, which is the parent node coordinate
 * `this` point [CanvasGraph](https://github.com/hizzgdev/jsmind/blob/master/src/jsmind.graph.js) Object
 * If you want to use `this` object, DO NOT use Arrow function expressions
 * */
function line_style(ctx, x1, y1, x2, y2) {
 ...
 * x1,y1 are start point, which is the child node coordinate, x2,y2 are end point, which is the parent node coordinate
 * `this` point [SvgGraph](https://github.com/hizzgdev/jsmind/blob/master/src/jsmind.graph.js) Object
 * If you want to use `this` object, DO NOT use Arrow function expressions
 */
function line_style(path, x1, y1, x2, y2) {
