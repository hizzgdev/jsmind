...
* [1. Usage](#1-usage)
  ...
  * [1.2. Empty mindmap](#12-empty-mindmap)
  * [1.3. Simple mindmap](#13-simple-mindmap)
  * [1.4. Data format](#14-data-format)
    * [(A) node tree](#a-node-tree)
    * [(B) node array](#b-node-array)
    * [(C) freemind](#c-freemind)
  * [1.5. Options](#15-options)
