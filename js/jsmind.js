...
; (function ($w) {
    ...
    jm.mind.prototype = {
        ...
        add_node: function (parent_node, nodeid, topic, data, idx, direction, expanded) {
            ...
            if (parent_node.isroot) {
                ...
                //当在根节点添加节点时，总是在右边添加
                if (jm.current.options.brokenLine) {
                    d = 1;
                }
    ...
    jm.util = {
        ...
        canvas: {
            bezierto_horizontal: function (ctx, x1, y1, x2, y2) {
                ctx.beginPath();
                ctx.moveTo(x1, y1);
                ctx.bezierCurveTo(x1 + (x2 - x1) * 2 / 3, y1, x1, y2, x2, y2);
                ctx.stroke();
            },
            bezierto_vertical: function (ctx, x1, y1, x2, y2) {
                ctx.beginPath();
                ctx.moveTo(x1, y1);
                ctx.bezierCurveTo(x1, y1 + (y2 - y1) * 2 / 3, x2, y1, x2, y2);
                ctx.stroke();
            },
            ...
            brokenlineto_vertical: function (ctx, x1, y1, x2, y2) {
                ctx.beginPath();
                ctx.moveTo(x1, y1);
            ...
            brokenlineto_horizontal: function (ctx, x1, y1, x2, y2) {
                ctx.beginPath();
                ctx.moveTo(x1, y1);
    ...
    jm.prototype = {
        ...
        add_node: function (parent_node, nodeid, topic, data) {
            if (this.get_editable()) {
                var node;
                if (this.options.displayVertical) {
    ...
    jm.layout_provider.prototype = {
        ...
        layout_offset: function () {
            ...
            while (i--) {
                subnode = children[i];
                if (this.jm.options.displayVertical) {
        ...
        get_node_point_out: function (node) {
            ...
            if (pout_cache.x == -1 || pout_cache.y == -1) {
                if (node.isroot) {
                    var view_data = node._data.view;
                    if (this.opts.brokenLine) {
                        if (this.opts.displayVertical) {
                            pout_cache.x = view_data.width / 2 + this.opts.pspace / 2 - 10;
                            pout_cache.y = 0;
                        }
                        else {
                            pout_cache.x = 0;
    ...
    jm.view_provider.prototype = {
        ...
        draw_line: function (pin, pout, offset, canvas_ctx) {
            ...
            if (this.jm.options.displayVertical) {
                if (!this.opts.brokenLine) {
                    jm.util.canvas.bezierto_vertical(
                        ctx,
                        pin.x + offset.x,
                        pin.y + offset.y,
                        pout.x + offset.x,
                    ...
                    jm.util.canvas.brokenlineto_vertical(
                        this.canvas_ctx,
                        pin.x + offset.x,
                        pin.y + offset.y,
                        pout.x + offset.x,
                ...
                if (!this.opts.brokenLine) {
                    jm.util.canvas.bezierto_horizontal(
                        ctx,
                        pin.x + offset.x,
                        pin.y + offset.y,
                        pout.x + offset.x,
                    ...
                    jm.util.canvas.brokenlineto_horizontal(
                        this.canvas_ctx,
                        pin.x + offset.x,
                        pin.y + offset.y,
                        pout.x + offset.x,
