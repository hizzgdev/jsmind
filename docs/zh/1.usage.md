...
从上面的例子里可以看到，你可以使用这些选项对 jsMind 进行个性化设置：
...
事实上，jsMind所支持的选项还有很多，请参阅[选项](2.apis.md)章节的详细介绍。
...
jmnodes.greensea jmnode{background-color:#1abc9c;color:#fff;}       /* 节点样式 */
jmnodes.greensea jmnode:hover{background-color:#16a085;}            /* 鼠标悬停的节点样式 */
jmnodes.greensea jmnode.selected{background-color:#11f;color:#fff;} /* 选中的节点样式 */
jmnodes.greensea jmnode.root{}                                      /* 根节点样式 */
jmnodes.greensea jmexpander{}                                       /* 展开/关闭节点的控制点样式 */
jmnodes.greensea jmexpander:hover{}                                 /* 鼠标悬停展开/关闭节点的控制点样式 */
```
