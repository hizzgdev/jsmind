 ...
 * this 指向 [CanvasGraph](https://github.com/hizzgdev/jsmind/blob/master/src/jsmind.graph.js) 对象
 * 如果需要用到this, 请勿使用箭头函数
 * */
 ...
 * x1,y1为起点, 为子节点坐标, x2,y2为终点, 为父节点坐标
 * this 指向 [SvgGraph](https://github.com/hizzgdev/jsmind/blob/master/src/jsmind.graph.js) 对象
 * 如果需要用到this, 请勿使用箭头函数
 */
